	...
	<body>
		<div class="d-flex flex-column vh-100" >
			<div class="container-fluid flex-grow-1">
				<div class="col">
					<div class="py-2 px-4">
						<div style="font-size: 20px" class="d-flex justify-content-center mb-2">상품 문의 답변 수정</div>
						<div class="mt-2">
							<form method="post" action="productInquiryAnswerUpdate">
								...
								<div class="input-group" style="width:100%;">
									...
									<textarea rows="10" cols="100" name="productInquiryAnswerContent">${originalAnswer}</textarea>
								</div>
